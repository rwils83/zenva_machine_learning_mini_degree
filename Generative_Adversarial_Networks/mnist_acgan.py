...
from tensorflow.keras.layers import Input, Dense, Reshape, Flatten, BatchNormalization, Embedding, multiply
...
def save_imgs(epoch, num_examples=100):
    ...
    for i in range(num_examples):
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig('images/ac_gan_generated_epoch_{0}.png'.format(epoch + 1))
